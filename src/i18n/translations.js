...
export const translations = {
  fr: {
    ...
    stats: [{ label: "Années d'études" }, { label: "Stages" }, { label: "Certifications" }, { label: "Projets fonctionnels" }],
  ...
  en: {
    ...
    stats: [{ label: "Years of Study" }, { label: "Internships" }, { label: "Certifications" }, { label: "Functional Projects" }],
  ...
  de: {
    ...
    stats: [{ label: "Studienjahre" }, { label: "Praktika" }, { label: "Zertifizierungen" }, { label: "Funktionale Projekte" }],
