  ...
  return (
    ...
    >
          ...
          {links.map(({ key, label }) => {
            ...
            return (
              <button
                ...
                style={{
                  color: isActive ? "#2c5f8a" : "var(--text-secondary)",
                }}
              ...
              >
                ...
                {isActive && (
                  <motion.span
                    ...
                    style={{ background: "linear-gradient(135deg, rgba(44,95,138,0.15), rgba(138,178,211,0.15))" }}
                ...
                >
                  {langs.map((l) => (
                    <button
                      ...
                      style={{
                        color: lang === l.code ? "#2c5f8a" : "var(--text-secondary)",
                        backgroundColor: lang === l.code ? "rgba(44,95,138,0.08)" : "transparent",
                      }}
                      onMouseEnter={(e) => { if (lang !== l.code) e.target.style.backgroundColor = "rgba(44,95,138,0.05)"; }}
      ...
      <div className="relative h-0.5" style={{ backgroundColor: "rgba(51,65,85,0.3)" }}>
        <motion.div
          className="absolute inset-y-0 left-0 bg-gradient-to-r from-navy-500 to-slate-400"
              ...
              {links.map(({ key, label }) => {
                ...
                return (
                  <button
                    ...
                    style={{
                  color: isActive ? "#2c5f8a" : "var(--text-secondary)",
                      backgroundColor: isActive ? "rgba(44,95,138,0.1)" : "transparent",
                    }}
                    onMouseEnter={(e) => { if (!isActive) e.target.style.backgroundColor = "rgba(44,95,138,0.05)"; }}
                ...
                <div className="flex gap-2">
                  {langs.map((l) => (
                    <button
                      ...
                      style={{
                        backgroundColor: lang === l.code ? "rgba(44,95,138,0.15)" : "transparent",
                        color: lang === l.code ? "#2c5f8a" : "var(--text-secondary)",
                        border: lang === l.code ? "1px solid rgba(44,95,138,0.3)" : "1px solid transparent",
                      }}
                    >
