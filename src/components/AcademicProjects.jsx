            ...
            {featured.map((proj, idx) => {
              ...
              return (
                <motion.div
                  ...
                  onMouseEnter={(e) => { e.currentTarget.style.borderColor = "rgba(201,169,110,0.4)"; e.currentTarget.style.boxShadow = "0 20px 40px rgba(201,169,110,0.1)"; e.currentTarget.style.transform = "translateY(-4px)"; }}
                ...
                >
                  <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-bordeaux-500 via-champagne-300 to-bordeaux-500" />
                  <div className="p-6 relative">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-champagne-400/5 to-transparent rounded-bl-full pointer-events-none" />
                    <div className="absolute -bottom-2 -right-2 w-20 h-20 bg-bordeaux-500/5 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />

                    <div className="flex items-start justify-between mb-3 relative">
                      <div className="flex items-center gap-2">
                        <h4 className="text-lg font-semibold group-hover:text-bordeaux-300 transition-colors" style={{ color: "var(--text-primary)" }}>
                          {proj.title}
                        </h4>
                        <span className="px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider rounded-full bg-gradient-to-r from-bordeaux-500/20 to-champagne-400/20 text-bordeaux-400 border border-bordeaux-500/20">
                          Featured
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3 relative">
                      {proj.github && (
                        <a
                          ...
                          onMouseEnter={(e) => { e.currentTarget.style.borderColor = "rgba(150,24,58,0.5)"; e.currentTarget.style.color = "#96183a"; }}
                      ...
                      {proj.live && (
                        <a
                          ...
                          rel="noreferrer"
                          className="inline-flex items-center gap-2 px-4 py-2 text-xs font-medium rounded-lg border transition-all duration-300 hover:scale-105"
                          style={{ borderColor: "rgba(201,169,110,0.3)", color: "#c9a96e", backgroundColor: "rgba(201,169,110,0.08)" }}
                          onMouseEnter={(e) => { e.currentTarget.style.borderColor = "rgba(201,169,110,0.6)"; e.currentTarget.style.boxShadow = "0 4px 12px rgba(201,169,110,0.15)"; }}
                          onMouseLeave={(e) => { e.currentTarget.style.borderColor = "rgba(201,169,110,0.3)"; e.currentTarget.style.boxShadow = "none"; }}
                        >
                ...
                >
                  <div className="p-6 relative">
                    ...
                    <div className="flex items-start justify-between mb-3 relative">
                      ...
                      <FaArrowRight className="text-slate-600 group-hover:text-champagne-300 group-hover:translate-x-1 transition-all duration-300 mt-1 shrink-0" />
                    </div>
